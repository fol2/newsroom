#!/usr/bin/env python3
"""Generate a truthful pre-write checkout-snapshot receipt for Increment 5A.
...
validator = replace_once(
    ...
    "truthful mutable-checkout claims",
)
validator = replace_once(
    validator,
...
''',
    '''    ) < emit.index("output.write(raw)") < emit.index("output.flush()")
''',
