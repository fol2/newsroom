...
- [`specs/editorial-automation/discovery-coverage-contract.md`](specs/editorial-automation/discovery-coverage-contract.md) is the Accepted Topic 1 coverage contract. It defines obligations independently from source and provider choices.
- [`specs/editorial-automation/discovery-workflow.md`](specs/editorial-automation/discovery-workflow.md) is the Accepted Topic 2 workflow from authorised trigger and source check through deterministic Candidate admission and evidence hand-off.
- [`specs/editorial-automation/discovery-record-semantics.md`](specs/editorial-automation/discovery-record-semantics.md) is the Topic 3 Draft defining proposed discovery identities, revisions, immutable versions and lineage without selecting a database.
