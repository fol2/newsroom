...
- [`specs/editorial-automation/graphrag-native-production-deployment.md`](specs/editorial-automation/graphrag-native-production-deployment.md) is the Draft detailed deployment amendment covering engine, repository, CI and release mechanics.
...
- [`adr/0004-source-registry-first-change-driven-discovery.md`](adr/0004-source-registry-first-change-driven-discovery.md) remains Proposed pending the detailed amendment and Topic 13 plan.
