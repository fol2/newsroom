...
- [`specs/editorial-automation/governed-graphrag-and-knowledge-projection.md`](specs/editorial-automation/governed-graphrag-and-knowledge-projection.md) is the Accepted governed GraphRAG core contract.
- [`specs/editorial-automation/graphrag-native-production-deployment.md`](specs/editorial-automation/graphrag-native-production-deployment.md) is the Draft native-production amendment. It supersedes the POC and optional-adoption interpretation.
...
- [`adr/0005-native-graphrag-production-deployment.md`](adr/0005-native-graphrag-production-deployment.md) is the Proposed decision that GraphRAG is mandatory in the first production deployment.
- [`plans/2026-07-16-005-native-graphrag-production-implementation.md`](plans/2026-07-16-005-native-graphrag-production-implementation.md) is the current Topic 13 Draft.
...
- [`adr/0004-source-registry-first-change-driven-discovery.md`](adr/0004-source-registry-first-change-driven-discovery.md) remains Proposed pending the native-production amendment and Topic 13 plan.
- [`specs/editorial-automation/news-discovery.md`](specs/editorial-automation/news-discovery.md) remains a Draft cross-cutting specification until those decisions are complete.
