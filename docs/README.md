...
- [`plans/2026-07-24-008-increment-2-complete-fixture-readiness.md`](plans/2026-07-24-008-increment-2-complete-fixture-readiness.md) is the Proposed implementation-readiness package for the first complete structural/full-text/vector/graph fixture slice. It requires owner review and authorises no code or run.
- [`plans/2026-07-24-009-increments-3-11-readiness-ladder.md`](plans/2026-07-24-009-increments-3-11-readiness-ladder.md) is the Proposed dependency, decision and stop-gate ladder for Increments 3–11. Blocked issue preparation does not create implementation or activation authority.
