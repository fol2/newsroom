...
- [`research/2026-07-25-increment-2a-substantive-review.md`](research/2026-07-25-increment-2a-substantive-review.md) records the current-head Increment 2A substantive review, seven corrected P2 findings and the remaining exact-head merge gates.
