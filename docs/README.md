...
- [`specs/editorial-automation/discovery-triage-and-event-grouping.md`](specs/editorial-automation/discovery-triage-and-event-grouping.md) is the Topic 6 Draft for Work Items, execution batches, retrieval, Event Hypotheses and Candidate formation. It is not yet accepted.
