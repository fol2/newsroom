...
**Graphiti SSOT (Slice A):** [`../../decisions/2026-08-20-graphiti.md`](../../decisions/2026-08-20-graphiti.md) and [`graphiti-corpus-ingestion-amendment.md`](graphiti-corpus-ingestion-amendment.md). Those records amend ingest scheduling, identity, temporal mapping and receipts. They do not rewrite `GRAG-*`.
