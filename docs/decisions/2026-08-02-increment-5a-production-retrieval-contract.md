...
- deterministic product code identifies and parses exact reviewed contract, schema, plan, and Epoch-policy bytes.
...
- **5E / #254:** Epoch-bound profile validation and hybrid qualification, six-class error reporting, production-readiness validation, Operational Profiles, least-privilege credentials and egress, full reconciliation recovery, scoped operational containment, security, purge, rollback, rebuild, and actual-Neo4j evidence.
