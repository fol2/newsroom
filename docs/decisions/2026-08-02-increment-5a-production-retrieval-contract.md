...
- **5E / #254:** hybrid-target qualification, comparative ablations, production-readiness validation, Operational Profiles, per-family blocking criteria, zero-tolerance temporal/rebuild gates, security, purge, recovery and actual-Neo4j qualification.
