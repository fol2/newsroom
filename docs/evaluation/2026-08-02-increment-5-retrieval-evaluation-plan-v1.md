...
- **Machine-record digest:** `sha256:4f5a9f33ee0fd657947294b5b48c2c0d73dfc668bf4ed21daeeb58fffab0aa40`
...
Every mandatory family is a separate blocking decision surface. Aggregate recall, aggregate MRR or another family's result cannot rescue a family that misses one of its frozen criteria. A family below its exposure floor is `NOT_EVALUATED`; a sufficiently exposed family that misses any criterion is `FAIL` for the affected qualification scope.
...
All rates retain exact numerators and denominators. Uncertainty is reported, but no confidence interval, reviewer judgment or aggregate score may lower these frozen point-estimate gates after outcomes are visible.
