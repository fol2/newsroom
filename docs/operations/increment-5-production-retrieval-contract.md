...
Retain bounded records for route/profile/generation identity; branch status, duration, count and truncation; fusion/dedup counts; hydration, rights and collision results; top-level outcome; response bytes; zero-call/zero-cost counters; component identities; and purge/rebuild linkage.
