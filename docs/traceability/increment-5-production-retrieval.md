...
|---|---:|---|
| 5A / #250 | 20 | Contract, schemas, frozen plan, authority/non-effect decisions and traceability |
...
| 5E / #254 | 52 | Operational Profiles/objectives, actual-service qualification, security, purge, recovery and decision evidence |
...
`DEVAL-010`, `DEVAL-011`, `DEVAL-012`, `DEVAL-051`, `DEVAL-072`, `DOPS-070`, `DOPS-076`, `GRAG-051`, `GRAG-052`, `GRAG-053`, `GRAG-058`, `GRPROD-002`, `GRPROD-003`, `GRPROD-004`, `GRPROD-013`, `GRPROD-014`, `GRPROD-015`, `GRPROD-020`, `GRPROD-023`, `GRPROD-032`.
