...
- An explicit evidence-bound reconciliation method can orphan only a non-current leaked ACTIVE lease without transitioning current work; exact lease and work authority are rechecked atomically so legacy host slots remain recoverable.
