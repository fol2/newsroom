...
ALL_SCOPES = frozenset(
    {
        ...
        "authority.objects.delete",
        "authority.objects.recovery",
        "authority.objects.gc",
    }
)
        ...
        rights_resolver=StaticRightsResolver(
            {
                "source-permitted": StaticRightsRule(
                    ...
                    allowed=rights_allowed,
                    reason_code=(
                        "RIGHTS_ALLOWED" if rights_allowed else "RIGHTS_PROHIBITED"
                    ),
