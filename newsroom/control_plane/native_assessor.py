...
SYSTEM = (
    ...
    "must exactly equal a HEADLINE or SUBSTANTIVE claim, at least one item must be a "
    "SUBSTANTIVE claim, and the HEADLINE must have qualification evidence supported "
