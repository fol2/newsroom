...
ISSUE_790_STEP17_PENDING_PLAN_PATH = Path(
    "docs/operations/2026-08-29-issue-790-success-sequence-step-17.pending-owner-review.json"
)
ISSUE_790_STEP18_PENDING_PLAN_PATH = Path(
    "docs/operations/2026-08-30-issue-790-success-sequence-step-18.pending-owner-review.json"
)
...
ISSUE_790_STEP21_PENDING_PLAN_PATH = Path(
    "docs/operations/2026-08-30-issue-790-success-sequence-step-21.pending-owner-review.json"
)
ISSUE_790_STEP22_PENDING_PLAN_PATH = Path(
    "docs/operations/2026-08-31-issue-790-success-sequence-step-22.pending-owner-review.json"
)
ISSUE_790_STEP23_PENDING_PLAN_PATH = Path(
    "docs/operations/2026-09-01-issue-790-success-sequence-step-23.pending-owner-review.json"
)
...
ISSUE_790_STEP21_CHECKED_APPROVED_AT = "2026-08-30T20:58:43.662872Z"
ISSUE_790_STEP22_CHECKED_APPROVED_AT = "2026-08-31T10:11:17.609260Z"
ISSUE_790_STEP23_CHECKED_APPROVED_AT = "2026-09-01T01:31:53.722227Z"
_EXHAUSTED_EVENT_8835 = {
    ...
    "last_failure_code": "BOUNDED_CANARY_AUTHORITY_EXHAUSTED:GATE_ValueError",
    "ledger_seq": 8835,
...
_EXHAUSTED_EVENT_8834 = {
    "attempt_count": 0,
    "available_at": "2026-08-26T08:41:34.385400Z",
    "event_id": (
...
_RETRY_FORBIDDEN_EVENTS_STEP17: tuple[dict[str, object], ...] = (
...
_EXHAUSTED_EVENT_13284 = {
    "attempt_count": 1,
    "available_at": "2026-08-30T12:00:42.331096Z",
    "event_id": (
        "sha256:fb49a59d1c421c261bab4586873680e50e8181acfd0d6ebc03a14f889147d896"
    ),
    "last_failure_code": (
        "BOUNDED_CANARY_AUTHORITY_EXHAUSTED:GraphitiAdapterContractError"
    ),
    "ledger_seq": 13284,
    "provider_dispatched": False,
    "state": "CONFIGURATION_HELD",
}
_RETRY_FORBIDDEN_EVENTS_STEP19: tuple[dict[str, object], ...] = (
...
_EXHAUSTED_EVENT_13362 = {
    "attempt_count": 1,
    "available_at": "2026-08-30T20:31:56.025450Z",
    "event_id": (
        "sha256:98d0ffbca828f6937b687751c711fec3be9182e679b2fcd041d3d14160f00c85"
    ),
...
_RETRY_FORBIDDEN_EVENTS_STEP21: tuple[dict[str, object], ...] = (
...
_RETRY_FORBIDDEN_EVENTS_STEP22: tuple[dict[str, object], ...] = (
    *_RETRY_FORBIDDEN_EVENTS_STEP20,
    _EXHAUSTED_EVENT_13361,
    _EXHAUSTED_EVENT_13362,
)
_EXHAUSTED_STEP23_EVENTS: tuple[dict[str, object], ...] = ({'attempt_count': 1,
  'available_at': '2026-08-31T15:25:10.756577Z',
  'event_id': 'sha256:b39a1e6ea465ca4a993893d4ae51c94ca9ac3e0db7f4fd70a8c780367263be6b',
  'last_failure_code': 'BOUNDED_CANARY_AUTHORITY_EXHAUSTED:AMBIGUOUS_EFFECT',
  'ledger_seq': 13665,
  'provider_dispatched': True,
  'state': 'CONFIGURATION_HELD'},
 {'attempt_count': 1,
  'available_at': '2026-08-31T18:33:06.133883Z',
  'event_id': 'sha256:db17fb48469b96b7134b9f0ab7c73c27ddc2f4ebb3bc6016fe268b6326ccb08e',
  'last_failure_code': 'BOUNDED_CANARY_AUTHORITY_EXHAUSTED:BrokerError',
  'ledger_seq': 13671,
  'provider_dispatched': False,
  'state': 'CONFIGURATION_HELD'},
 {'attempt_count': 1,
  'available_at': '2026-08-31T19:08:34.928456Z',
  'event_id': 'sha256:1f60dac732657a0d89a9d46528aed13bcd7e2af5157a5bc6541bed579067705c',
  'last_failure_code': 'BOUNDED_CANARY_AUTHORITY_EXHAUSTED:AMBIGUOUS_EFFECT',
  'ledger_seq': 13677,
  'provider_dispatched': True,
  'state': 'CONFIGURATION_HELD'},
 {'attempt_count': 1,
  'available_at': '2026-08-31T19:58:00.274309Z',
  'event_id': 'sha256:7d7bd60fac66b52c7e945a97021570e4220e3fdee0c01af4ee744a50a3993944',
  'last_failure_code': 'BOUNDED_CANARY_AUTHORITY_EXHAUSTED:AMBIGUOUS_EFFECT',
  'ledger_seq': 13683,
  'provider_dispatched': True,
  'state': 'CONFIGURATION_HELD'},
 {'attempt_count': 1,
  'available_at': '2026-08-31T21:09:43.725082Z',
  'event_id': 'sha256:0cf4c6da7a7be611d10fb87f82a7038ca42296f6112d5a2a03fcfb35abde9a39',
  'last_failure_code': 'BOUNDED_CANARY_AUTHORITY_EXHAUSTED:NO_EVENT_RESULT',
  'ledger_seq': 13689,
  'provider_dispatched': False,
  'state': 'CONFIGURATION_HELD'},
 {'attempt_count': 1,
  'available_at': '2026-09-01T00:37:11.511490Z',
  'event_id': 'sha256:57bfeadea2a60c8f24a269c0985611ea8828fcaeaccbfd1b7bed84b537293666',
  'last_failure_code': 'BOUNDED_CANARY_AUTHORITY_EXHAUSTED:GuardError',
  'ledger_seq': 13690,
  'provider_dispatched': True,
  'state': 'CONFIGURATION_HELD'},
 {'attempt_count': 1,
  'available_at': '2026-09-01T01:24:52.778230Z',
  'event_id': 'sha256:a50799d126f82a229e1630816ea27a0e3fff2731fee87b48c986bc0f9b51b7f2',
  'last_failure_code': None,
  'ledger_seq': 13696,
  'provider_dispatched': True,
  'state': 'TERMINAL'})
_RETRY_FORBIDDEN_EVENTS_STEP23: tuple[dict[str, object], ...] = (
...
def _validated_reviewed_fix(value: object) -> dict[str, object]:
    ...
    if "corrected_red_revision" in fix:
        expected_fields.add("corrected_red_revision")
    if supplied_digest != digest_canonical(unsigned) or set(fix) != expected_fields:
    ...
    if (
        ...
        or (
            "corrected_red_revision" in fix
            and re.fullmatch(r"[0-9a-f]{40}", _text(fix, "corrected_red_revision")) is None
        )
        or any(
...
def _validated_step18_gate_outcome(value: object) -> dict[str, object]:
    outcome = _record(value, field="pre-consumption gate outcome")
    supplied = outcome.get("outcome_digest")
    unsigned = {key: item for key, item in outcome.items() if key != "outcome_digest"}
    if supplied != digest_canonical(unsigned) or set(outcome) != {
        "schema_version", "issue", "plan_digest", "activation_digest",
        "checked_candidate_digest", "event_id", "ledger_seq", "result_class",
        "failure_code", "authority_consumed", "consumption_rows",
        "provider_dispatched", "provider_calls", "catalogue_queries",
        "retry_count", "fallback_count", "evidence_reference", "observed_at",
        "outcome_digest",
    }:
        raise Issue790DispositionError("issue #790 pre-consumption gate outcome differs")
    if (
        outcome.get("schema_version")
        != "newsroom.issue-790.preconsumption-gate-outcome.v1"
        or outcome.get("issue") != 790
        or outcome.get("plan_digest")
        != issue_790_contract_module.ISSUE_790_STEP17_ACTIVATED_PLAN_DIGEST
        or outcome.get("activation_digest")
        != issue_790_contract_module.ISSUE_790_STEP17_ACTIVATION_DIGEST
        or outcome.get("checked_candidate_digest")
        != issue_790_contract_module.ISSUE_790_STEP17_CHECKED_CANDIDATE_DIGEST
        or outcome.get("event_id") != _EXHAUSTED_EVENT_8834["event_id"]
        or outcome.get("ledger_seq") != 8834
        or outcome.get("result_class") != "PRECONSUMPTION_GATE_NON_SUCCESS"
        or outcome.get("failure_code")
        != "RESOLVED_INGEST_IDS_DIFFER_FROM_LANDED"
        or outcome.get("authority_consumed") is not False
        or outcome.get("consumption_rows") != 0
        or outcome.get("provider_dispatched") is not False
        or any(outcome.get(field) != 0 for field in (
            "provider_calls", "catalogue_queries", "retry_count", "fallback_count"
        ))
        or outcome.get("outcome_digest")
        != issue_790_contract_module.ISSUE_790_STEP17_GATE_OUTCOME_DIGEST
    ):
        raise Issue790DispositionError("issue #790 pre-consumption gate outcome differs")
    _instant(outcome.get("observed_at"), field="pre-consumption gate observed_at")
    _text(outcome, "evidence_reference")
    return outcome


def _validated_step18_candidate_qualification(value: object) -> dict[str, object]:
    receipt = _record(value, field="candidate event qualification")
    supplied = receipt.get("qualification_digest")
    unsigned = {
        key: item for key, item in receipt.items() if key != "qualification_digest"
    }
    if supplied != digest_canonical(unsigned) or set(receipt) != {
        "schema_version", "status", "event_id", "ledger_seq",
        "event_manifest_digest", "event_preflight_digest", "resolved_unit_count",
        "provider_calls", "store_mutations", "observed_at", "qualification_digest",
    }:
        raise Issue790DispositionError("issue #790 candidate qualification differs")
    if (
        receipt.get("schema_version")
        != "newsroom.issue-790.candidate-event-qualification.v1"
        or receipt.get("status") != "READY_FOR_OWNER_PACKET"
        or receipt.get("provider_calls") != 0
        or receipt.get("store_mutations") != 0
        or not isinstance(receipt.get("resolved_unit_count"), int)
        or isinstance(receipt.get("resolved_unit_count"), bool)
        or int(receipt["resolved_unit_count"]) <= 0
    ):
        raise Issue790DispositionError("issue #790 candidate qualification differs")
    for field in (
        "event_id", "event_manifest_digest", "event_preflight_digest",
        "qualification_digest",
    ):
        if re.fullmatch(r"sha256:[0-9a-f]{64}", _text(receipt, field)) is None:
            raise Issue790DispositionError("issue #790 candidate qualification differs")
    _instant(receipt.get("observed_at"), field="candidate qualification observed_at")
    return receipt
...
def validate_issue_790_plan(value: Mapping[str, object]) -> dict[str, object]:
    ...
    sequence_preview = plan.get("sequence")
    expected_retry = _RETRY_FORBIDDEN_EVENTS
    if iterative and isinstance(sequence_preview, dict):
        if sequence_preview.get("sequence_ordinal") == 17:
            expected_retry = _RETRY_FORBIDDEN_EVENTS_STEP17
        elif sequence_preview.get("sequence_ordinal") == 18:
        ...
        elif sequence_preview.get("sequence_ordinal") == 21:
            expected_retry = _RETRY_FORBIDDEN_EVENTS_STEP21
        elif sequence_preview.get("sequence_ordinal") == 22:
            expected_retry = _RETRY_FORBIDDEN_EVENTS_STEP22
        elif sequence_preview.get("sequence_ordinal") == 23:
            expected_retry = _RETRY_FORBIDDEN_EVENTS_STEP23
    ...
    if iterative:
        ...
        if issue_790_owner_activated_sequence(sequence.get("sequence_ordinal")):
        ...
        if sequence.get("sequence_ordinal") == 18:
            expected_sequence_fields.update(
                {
                    "predecessor_activation_digest",
                    "predecessor_checked_candidate_digest",
                    "predecessor_gate_outcome",
                    "candidate_event_qualification",
                    "candidate_event_preparation_digest",
                }
            )
        if sequence.get("sequence_ordinal") == 19:
            expected_sequence_fields.update(
                {
                    "predecessor_canary_receipt_digest",
                    "predecessor_activation_digest",
        ...
        if sequence.get("sequence_ordinal") == 21:
            expected_sequence_fields.update(
                {
                    "predecessor_canary_receipt_digest",
                    "predecessor_activation_digest",
        ...
        if sequence.get("sequence_ordinal") in {22, 23}:
            expected_sequence_fields.update(
                {
                    "predecessor_canary_receipt_digest",
                    "predecessor_activation_digest",
        ...
        predecessor_fields = {
            "plan_digest", "consumption_digest", "outcome_digest", "event_id",
            "ledger_seq",
        }
        digest_fields = ("consumption_digest", "outcome_digest")
        if ordinal == 18:
            predecessor_fields = {
                "plan_digest", "gate_outcome_digest", "event_id", "ledger_seq"
            }
            digest_fields = ("gate_outcome_digest",)
        if ordinal in {20, 21, 22, 23}:
            predecessor_fields = {
        ...
        if issue_790_owner_activated_sequence(sequence.get("sequence_ordinal")):
            if (
                ...
                raise Issue790DispositionError(
                    "issue #790 owner-activated identity fields differ"
                )
            expected_predecessor = {
                16: ISSUE_790_SUCCESS_SEQUENCE_STEP_15_PLAN_DIGEST,
                ...
                21: issue_790_contract_module.ISSUE_790_STEP20_ACTIVATED_PLAN_DIGEST,
                22: issue_790_contract_module.ISSUE_790_STEP21_ACTIVATED_PLAN_DIGEST,
                23: issue_790_contract_module.ISSUE_790_STEP22_ACTIVATED_PLAN_DIGEST,
            ...
            if sequence.get("sequence_ordinal") == 18:
                gate_outcome = _validated_step18_gate_outcome(
                    sequence.get("predecessor_gate_outcome")
                )
                qualification = _validated_step18_candidate_qualification(
                    sequence.get("candidate_event_qualification")
                )
                if (
                    sequence.get("predecessor_activation_digest")
                    != issue_790_contract_module.ISSUE_790_STEP17_ACTIVATION_DIGEST
                    or sequence.get("predecessor_checked_candidate_digest")
                    != issue_790_contract_module.ISSUE_790_STEP17_CHECKED_CANDIDATE_DIGEST
                    or predecessor.get("gate_outcome_digest")
                    != gate_outcome.get("outcome_digest")
                    or predecessor.get("event_id") != gate_outcome.get("event_id")
                    or predecessor.get("ledger_seq") != gate_outcome.get("ledger_seq")
                    or qualification.get("qualification_digest")
                    != (
                        "sha256:598445df7fadc3a33336608da40df103b2d952f9422ea22055b19d7c55342c78"
                    )
                    or sequence.get("candidate_event_preparation_digest")
                    != (
                        "sha256:744092a31f395cd17bb3cd6c92a08de519c137212b6b02ea23f256f07e2c016f"
                    )
                ):
                    raise Issue790DispositionError(
                        "issue #790 Step 18 successor binding differs"
                    )
            if sequence.get("sequence_ordinal") == 19:
                qualification = _validated_step18_candidate_qualification(
                    sequence.get("candidate_event_qualification")
                ...
                if (
                    ...
                    != (
                        "sha256:7ef9c2ce36244db08804b601b7b953b3d5ea524c51bbc6c08fce82930dd750bb"
                    )
                    or qualification.get("qualification_digest")
                    != (
                    ...
                    or sequence.get("candidate_event_preparation_digest")
                    != (
                        "sha256:88b7b0c900f6775a3f8935eaeb627f7cdb40391d347cd646f5442b60b2a54506"
                    )
                ):
                    raise Issue790DispositionError(
            ...
            if sequence.get("sequence_ordinal") == 21:
                ...
                if (
                    sequence.get("predecessor_activation_digest")
                    != issue_790_contract_module.ISSUE_790_STEP20_ACTIVATION_DIGEST
                    or sequence.get("predecessor_canary_receipt_digest")
                    != (
                        "sha256:33013e8ce7b9731a05f5eff45449aecab4bdc8a29f5f13cee98a7bf66146d265"
                    )
                    or predecessor.get("outcome_digest")
                    != (
                        "sha256:61798958ab3b32d8904d8ab054d95990d181cd040e8c4c335d41436661ad2c86"
                    )
                    or predecessor.get("event_id") != _EXHAUSTED_EVENT_13362["event_id"]
                    or predecessor.get("ledger_seq") != 13362
                    or qualification.get("qualification_digest")
                    != (
                    ...
                    raise Issue790DispositionError(
                        "issue #790 Step 21 successor binding differs"
                    )
            if sequence.get("sequence_ordinal") == 22:
                qualification = _validated_step18_candidate_qualification(
                    sequence.get("candidate_event_qualification")
                )
                if (
                    sequence.get("predecessor_activation_digest")
                    != issue_790_contract_module.ISSUE_790_STEP21_ACTIVATION_DIGEST
                    or sequence.get("predecessor_canary_receipt_digest")
                    != (
                        "sha256:152da04e879640d557b6c8742254f1eb0ccc0c2471b0d05eff975076e17127e0"
                    )
                    or predecessor.get("outcome_digest")
                    != (
                        "sha256:c15908dcd008860de77f505ba6910be2aa0de56f21f37acc3c639e716b2ecf1f"
                    )
                    or predecessor.get("event_id") != _EXHAUSTED_EVENT_13361["event_id"]
                    or predecessor.get("ledger_seq") != 13361
                    or qualification.get("qualification_digest")
                    != (
                    ...
                    raise Issue790DispositionError(
                        "issue #790 Step 22 successor binding differs"
                    )
            if sequence.get("sequence_ordinal") == 23:
                qualification = _validated_step18_candidate_qualification(
                    sequence.get("candidate_event_qualification")
                )
                if (
                    sequence.get("predecessor_activation_digest") != issue_790_contract_module.ISSUE_790_STEP22_ACTIVATION_DIGEST
                    or sequence.get("predecessor_canary_receipt_digest") != "sha256:8a5c32f2e7327221e2fb082e0d25bc9530b4688a39ec9d6b193da49afaa1f9cc"
                    or predecessor.get("outcome_digest") != "sha256:6a3c9f19717104e42cda8ea5a06c692a99465a1e95104033e89d8fecf3151463"
                    or predecessor.get("event_id") != _EXHAUSTED_STEP23_EVENTS[-1]["event_id"]
                    or predecessor.get("ledger_seq") != 13696
                    or qualification.get("qualification_digest") != "sha256:c1dca544d0de449d7a951d3673858ce7700e5271ad56a372ba0706a3fae6604c"
                    or sequence.get("candidate_event_preparation_digest") != "sha256:90ef3df005e95df3f0343ecd312d47859b4698387d8b27d91fb3abba2f3f650d"
                ):
                    raise Issue790DispositionError("issue #790 Step 23 successor binding differs")
            ...
            try:
                issue_790_checked_candidate_contract(
                    str(owner_activation["checked_candidate_digest"])
                )
            ...
            if (
                owner_activation["caps"] != _STEP16_OWNER_CAPS
        ...
        if constraint_change in _ISSUE_790_REVIEWED_SUCCESSOR_TRANSITIONS:
            ...
            predecessor_outcome_digest = predecessor.get(
                "gate_outcome_digest", predecessor.get("outcome_digest")
            )
            if (
                causal_report.get("schema_version")
                != ISSUE_790_NON_TIMEOUT_CAUSAL_REPORT_SCHEMA
                or reviewed_fix.get("predecessor_outcome_digest")
                != predecessor_outcome_digest
...
def _step18_candidate_qualification(
    plan: Mapping[str, object],
) -> dict[str, object] | None:
    sequence = plan.get("sequence")
    if (
        not isinstance(sequence, dict)
        or sequence.get("sequence_ordinal") not in {18, 19, 21, 22, 23}
    ):
        return None
    return _validated_step18_candidate_qualification(
        sequence.get("candidate_event_qualification")
    )
...
def _require_step16_runtime_semantics(
    ...
    *,
    ...
    forbidden_ledger_seqs = {
        int(item["ledger_seq"])
        for item in retry_events
        if isinstance(item, dict)
        and isinstance(item.get("ledger_seq"), int)
        and not isinstance(item.get("ledger_seq"), bool)
    } if isinstance(retry_events, list) else set()
    if (
        ...
        or not isinstance(ledger_seq, int)
        or ledger_seq <= 0
        or ledger_seq in forbidden_ledger_seqs
...
def _require_approved_plan(
    ...
    *,
    ...
    sequence = plan.get("sequence")
    step16 = isinstance(sequence, dict) and issue_790_owner_activated_sequence(
        sequence.get("sequence_ordinal")
    )
    if step16:
        ...
        if contract.sequence_ordinal == 1:
            ...
            try:
                ...
                activated_predecessor = {
                    ...
                    21: (
                        issue_790_contract_module.ISSUE_790_STEP20_ACTIVATED_PLAN_DIGEST,
                        issue_790_contract_module.ISSUE_790_STEP20_ACTIVATION_DIGEST,
                    ),
                    22: (
                        issue_790_contract_module.ISSUE_790_STEP21_ACTIVATED_PLAN_DIGEST,
                        issue_790_contract_module.ISSUE_790_STEP21_ACTIVATION_DIGEST,
                    ),
                    23: (
                        issue_790_contract_module.ISSUE_790_STEP22_ACTIVATED_PLAN_DIGEST,
                        issue_790_contract_module.ISSUE_790_STEP22_ACTIVATION_DIGEST,
                    ),
                }.get(contract.sequence_ordinal)
                if (
                    activated_predecessor is None
                    or contract.predecessor_plan_digest
                    != activated_predecessor[0]
                    or sequence.get("predecessor_activation_digest")
                    != activated_predecessor[1]
...
def _retry_event_snapshots(
    store: Path,
    events: tuple[dict[str, object], ...] | None = None,
) -> list[dict[str, object]]:
    expected = events if events is not None else _RETRY_FORBIDDEN_EVENTS
    seqs = tuple(int(item["ledger_seq"]) for item in expected)
...
def _require_retry_events_unchanged(
    ...
    retained = _retry_event_snapshots(
        store,
        tuple(_record(item, field="retry-forbidden event") for item in expected)
...
def _require_retry_exclusions(
    ...
    *,
    ...
    if (
        ...
        or len(retained) != len(expected_events)
...
def _require_sequence_predecessor(
    ...
    *,
    ...
    if ordinal == 18:
        ...
        try:
            activation = step16_activation_module.load_step16_activation_record(
                connection,
            ...
            connection.close()
        if (
            activation.get("activation_digest")
            != sequence.get("predecessor_activation_digest")
            or activation.get("checked_candidate_digest")
            != sequence.get("predecessor_checked_candidate_digest")
            or predecessor.get("gate_outcome_digest")
            != gate_outcome.get("outcome_digest")
            or predecessor.get("event_id") != gate_outcome.get("event_id")
            or predecessor.get("ledger_seq") != gate_outcome.get("ledger_seq")
            or repository.existing_consumption(approved_plan_digest=plan_digest)
            is not None
        ):
            raise Issue790DispositionError(
                "issue #790 pre-consumption predecessor differs"
            )
        return {"activation": activation, "gate_outcome": gate_outcome}
    consumption = repository.existing_consumption(
        approved_plan_digest=plan_digest,
        event_id=str(predecessor["event_id"]),
        ledger_seq=int(predecessor["ledger_seq"]),
    )
    consumption_matches = (
    ...
    authority_drift_success = (
        ordinal == 23
        and plan_digest
        == issue_790_contract_module.ISSUE_790_STEP22_ACTIVATED_PLAN_DIGEST
        and sequence.get("predecessor_activation_digest")
        == issue_790_contract_module.ISSUE_790_STEP22_ACTIVATION_DIGEST
        and sequence.get("predecessor_canary_receipt_digest")
        == "sha256:8a5c32f2e7327221e2fb082e0d25bc9530b4688a39ec9d6b193da49afaa1f9cc"
        and causal_report.get("boundary") == "BOUNDED_CANARY_SINGLE_USE_AUTHORITY"
        and predecessor.get("outcome_digest")
        == "sha256:6a3c9f19717104e42cda8ea5a06c692a99465a1e95104033e89d8fecf3151463"
        and outcome.get("outcome_digest")
        == "sha256:6a3c9f19717104e42cda8ea5a06c692a99465a1e95104033e89d8fecf3151463"
        and predecessor.get("event_id")
        == "sha256:a50799d126f82a229e1630816ea27a0e3fff2731fee87b48c986bc0f9b51b7f2"
        and predecessor.get("ledger_seq") == 13696
        and outcome.get("result_class") == "TRUTHFUL_PROVIDER_SUCCESS"
        and outcome.get("state_before_seal") == "TERMINAL"
        and outcome.get("state_after_seal") == "TERMINAL"
    ...
    if (
        outcome.get("result_class") == "TRUTHFUL_PROVIDER_SUCCESS"
        and not authority_drift_success
    ):
        raise Issue790DispositionError(
    ...
    if ordinal == 1:
        ...
        if (
            ...
            != "newsroom.issue-790.canary-outcome.v3"
            or outcome.get("result_class")
            not in {
                "UNCLASSIFIED_NON_SUCCESS",
                "TRUTHFUL_PROVIDER_SUCCESS" if authority_drift_success else "",
            }
...
def collect_issue_790_operational_evidence(
    *,
    ...
    store: Path,
    observed_at: datetime,
    retry_forbidden_events: tuple[dict[str, object], ...] | None = None,
) -> dict[str, object]:
    ...
    expected_retry = (
        retry_forbidden_events
        if retry_forbidden_events is not None
    ...
    *,
    ...
    try:
        ...
        if (
            ...
            and issue_790_owner_activated_sequence(sequence.get("sequence_ordinal"))
        ):
...
def _run_issue_790_canary_locked(
    *,
    ...
    try:
        if isinstance(sequence, dict) and issue_790_owner_activated_sequence(
            sequence.get("sequence_ordinal")
        ):
            if recovering:
...
def issue_790_checked_approval(pending_digest: str) -> dict[str, str]:
    """Return the checked, non-live approval tuple for one pending family."""

    if re.fullmatch(r"sha256:[0-9a-f]{64}", pending_digest) is None:
        raise Issue790DispositionError("issue #790 pending digest differs")
    try:
        contract = issue_790_checked_candidate_contract_for_pending(pending_digest)
    except KeyError as exc:
        raise Issue790DispositionError(
            "issue #790 pending digest differs"
        ) from exc
    approved_at = {
        16: ISSUE_790_STEP16_CHECKED_APPROVED_AT,
        ...
        21: ISSUE_790_STEP21_CHECKED_APPROVED_AT,
        22: ISSUE_790_STEP22_CHECKED_APPROVED_AT,
        23: ISSUE_790_STEP23_CHECKED_APPROVED_AT,
    }[contract.sequence_ordinal]
    return {
        "approved_by": contract.checked_approved_by,
        "approval_reference": contract.checked_approval_reference,
...
def _bind_step16_pending_family(
    ...
    *,
    ...
    try:
        pending_contract = issue_790_checked_candidate_contract_for_pending(
            str(pending_plan["canonical_digest"])
        )
    except KeyError as exc:
        raise Issue790DispositionError(
            "issue #790 pending plan ordinal differs"
        ) from exc
    if sequence.get("sequence_ordinal") != pending_contract.sequence_ordinal:
        raise Issue790DispositionError("issue #790 pending plan ordinal differs")
    predecessor = _record(sequence.get("predecessor"), field="predecessor")
    if predecessor.get("plan_digest") != pending_contract.predecessor_plan_digest:
...
def validate_issue_790_step16_candidate(
    ...
    if contract.sequence_ordinal in {18, 19, 21, 22, 23}:
        qualification = _validated_step18_candidate_qualification(
            sequence.get("candidate_event_qualification")
        )
        if (
            qualification.get("qualification_digest")
            != contract.candidate_event_qualification_digest
            or qualification.get("event_id") != contract.candidate_event_id
            or qualification.get("ledger_seq") != contract.candidate_ledger_seq
            or qualification.get("event_manifest_digest")
            != contract.candidate_event_manifest_digest
        ):
            raise Issue790DispositionError("issue #790 candidate event binding differs")
        if contract.sequence_ordinal == 18:
            gate_outcome = _validated_step18_gate_outcome(
                sequence.get("predecessor_gate_outcome")
            )
            if gate_outcome.get("outcome_digest") != predecessor.get(
                "gate_outcome_digest"
            ):
                raise Issue790DispositionError(
                    "issue #790 Step 18 candidate binding differs"
                )
    return candidate
...
def seal_issue_790_step16_plan(
    ...
    *,
    ...
    if (
        ...
        != pending_contract.checked_approval_reference
        or checked.get("approved_at") != expected_approved_at
...
def _assemble_step16_owner_plan(
    ...
    *,
    ...
    try:
        issue_790_checked_candidate_contract(str(retained["canonical_digest"]))
    except KeyError as exc:
        raise Issue790DispositionError(
            "issue #790 candidate identity differs"
        ) from exc
...
def qualify_issue_790_step16_readiness(
    *,
    ...
    selected = _step18_candidate_qualification(retained)
    if selected is not None and (
        candidate.get("event_id") != selected.get("event_id")
        or candidate.get("ledger_seq") != selected.get("ledger_seq")
        or candidate.get("event_manifest_digest")
        != selected.get("event_manifest_digest")
    ):
        raise Issue790DispositionError("issue #790 selected candidate drifted")
    connection = sqlite3.connect(f"{store.absolute().as_uri()}?mode=ro", uri=True)
    try:
        record = step16_activation_module.load_step16_activation_record(
            connection,
    ...
    if selected is not None:
        unsigned["checked_candidate_event_qualification_digest"] = selected[
            "qualification_digest"
        ]
...
__all__ = [
    ...
    "ISSUE_790_STEP23_PENDING_PLAN_PATH",
