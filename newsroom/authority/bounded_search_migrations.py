...
BOUNDED_SEARCH_MIGRATION_STATEMENTS: tuple[str, ...] = (
    ...
    f"""CREATE TABLE search_budget_ledger(
        ...
        entry_kind TEXT NOT NULL CHECK(entry_kind IN ('ATTEMPT_ALLOCATION','OUTCOME','RESULT_REFERENCE','REVIEW_DECISION','DOWNSTREAM_WORK')),
        ...
        CHECK(
            (entry_kind='ATTEMPT_ALLOCATION' AND outcome_id IS NULL
