...
INCREMENT_1A2B_TRACEABILITY: dict[str, tuple[str, ...]] = {
    ...
    "newsroom.authority._event_store_base": _COMMON,
    "newsroom.authority._event_store_commit": _COMMON,
    "newsroom.authority.models": _COMMON,
    "newsroom.authority.service": _COMMON,
    ...
    "newsroom.tests.test_authority_a2b_object_commands": _COMMON,
