...
_ANCHOR_GROUPS: tuple[tuple[str, frozenset[str]], ...] = (
    ...
    (
        f"{_PRIOR_INCREMENT3}#3E-07-ACTUAL-NEO4J-EVIDENCE/GRAG-042-GRAG-045",
        frozenset({"GRAG-042"}),
    ),
    (
        f"{_PRIOR_INCREMENT4}#GRPROD-003",
        frozenset({"GRPROD-003"}),
    ),
    (
    ...
    (
        f"{_PRIOR_INCREMENT4}#GRPROD-013",
        frozenset({"GRPROD-013"}),
    ),
    (
        f"{_PRIOR_INCREMENT4}#GRPROD-014",
        frozenset({"GRPROD-014"}),
    ),
    (
    ...
    (
        f"{_PRIOR_INCREMENT4}#GRPROD-020",
        frozenset({"GRPROD-020"}),
    ),
    (
    ...
    (
        ...
        frozenset({"GRAG-051", "GRAG-053", "GRPROD-012"}),
    ),
    (
    ...
    (
        f"{_MACHINE_EVALUATION}#/decision_scope",
        frozenset({"GRAG-055"}),
    ),
    (
