...
_ANCHOR_GROUPS: tuple[tuple[str, frozenset[str]], ...] = (
    ...
    (
        "issue:#254:deferred:retry-classification-bounded-backoff-health-and-circuit-controls",
        frozenset({"DOPS-030", "DOPS-031", "DOPS-032", "DOPS-033", "DOPS-034"}),
    ),
    (
        "issue:#254:deferred:bounded-role-aware-contingency-activation-and-deactivation",
        frozenset({"DOPS-037"}),
    ),
    (
