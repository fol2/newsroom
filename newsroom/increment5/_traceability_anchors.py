...
# Each group is one explicit semantic claim. Construction fails if a
# requirement is omitted or appears under competing anchors.
_ANCHOR_GROUPS: tuple[tuple[str, frozenset[str]], ...] = (
    ...
    (
        ...
        frozenset({"GRAG-034", "GRAG-035", "DOPS-026", "TRI-022"}),
    ),
    (
