...
def validate_increment5_traceability() -> None:
    ...
    expected_counts = {
        Increment5DeliveryTrace.DELIVERED_IN_5A: 16,
        ...
        Increment5DeliveryTrace.SATISFIED_BY_PRIOR_INCREMENT: 6,
    }
    actual_counts = {
        delivery: sum(
    ...
    for requirement, expected_anchor in prior_increment_graph_anchors.items():
