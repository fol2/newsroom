...
def _compile_profile_api() -> tuple[
    ...
    def load_canonical_schema(path: Path, expected_digest: str) -> dict[str, Any]:
        try:
            raw = path.read_bytes()
    ...
    def compile_schema(
        *,
        ...
        binding = load_canonical_schema(binding_path, binding_digest)
        structural = load_canonical_schema(structural_path, structural_digest)
        ...
        return schema_validator_type(binding)
